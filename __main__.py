...
caption = """Бесконечный brainrot

Это сообщение своего рода quine. Телеграм бот каждую минуту редактирует это сообщение целиком и меняет видео.

В статическом мире телеграма этот пост "особенный".

github.com/nottgy/interactive-chat"""
